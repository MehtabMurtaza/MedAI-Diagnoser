...
export const StateContexts = {
  ...
  reflex___state____state__cal_hacks_app____cal_hacks_app____state: createContext(null),
...
export const lastCompiledTimeStamp = "2024-10-20 07:27:14.029742"
...
export function StateProvider({ children }) {
  ...
  const [reflex___state____state__cal_hacks_app____cal_hacks_app____state, dispatch_reflex___state____state__cal_hacks_app____cal_hacks_app____state] = useReducer(applyDelta, initialState["reflex___state____state.cal_hacks_app____cal_hacks_app____state"])
  ...
  const dispatchers = useMemo(() => {
    return {
      ...
      "reflex___state____state.cal_hacks_app____cal_hacks_app____state": dispatch_reflex___state____state__cal_hacks_app____cal_hacks_app____state,
  ...
  return (
    ...
    <StateContexts.reflex___state____state__cal_hacks_app____cal_hacks_app____state.Provider value={ reflex___state____state__cal_hacks_app____cal_hacks_app____state }>
    ...
    </StateContexts.reflex___state____state__cal_hacks_app____cal_hacks_app____state.Provider>
